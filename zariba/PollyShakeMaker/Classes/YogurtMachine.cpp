...
Scene* YogurtMachine::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = YogurtMachine::create();
...
bool YogurtMachine::init()
{
    ...
    auto backButton = MenuItemSprite::create(Sprite::create("SliceTheFruits/buton_1.png"),
                                    ...
                                    CC_CALLBACK_1(YogurtMachine::GoToScene, this));
    backButton->setTag(1);
...
void YogurtMachine::GoToScene(cocos2d::Ref* pSender){
...
void YogurtMachine::menuCloseCallback(Ref* pSender)
{
